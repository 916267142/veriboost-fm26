...
set key width 3 Left vertical maxrows 1 reverse samplen 1 at screen 0.85, 1.06  font ',11' spacing 2
...
### output
set output 'results/TotalTime-Simulation-Much-ThreeGraph-BGP.pdf'
...
plot 'data/TotalTime-Simulation-BGP-Much-K1.dat' u 2:xtic(1) w histogram fs pattern 3 ls 2 t'Batfish', \
...
plot 'data/TotalTime-Simulation-BGP-Much-K2.dat' u 2:xtic(1) w histogram fs pattern 3 ls 2 t'Batfish', \
	'' u 4 w histogram fs pattern 2 ls 3 t'Batfish(VeriBoost)', \
	'' u 3 w histogram fs pattern 3 ls 3 t'DNA', \
	'' u 5 w histogram fs pattern 7 ls 5 t'DNA(VeriBoost)', \
...
plot 'data/TotalTime-Simulation-BGP-Much-K3.dat' u 2:xtic(1) w histogram fs pattern 3 ls 2 t'Batfish', \
	'' u 4 w histogram fs pattern 2 ls 3 t'Batfish(VeriBoost)', \
	'' u 3 w histogram fs pattern 3 ls 3 t'DNA', \
	'' u 5 w histogram fs pattern 7 ls 5 t'DNA(VeriBoost)', \
